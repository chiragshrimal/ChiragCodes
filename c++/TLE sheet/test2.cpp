...
long long mergeAndCount(vector<int>& arr, int left, int mid, int right) {
    ...
    // Copy back to original array (required for correct counting in further merges)
...
void solve()
{
    ...
    int c1=countInversions(even,0,even.size()-1);
    int c2=countInversions(odd,0,odd.size()-1);
